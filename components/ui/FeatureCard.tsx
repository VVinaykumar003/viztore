...
export default function FeatureCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4"> {/* Added a flex container for icon and title */}
        <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-2xl bg-viz-primary/10 text-viz-primary transition-colors duration-300 group-hover:bg-viz-primary group-hover:text-white">
          <Icon size={22} strokeWidth={2} />
        </div>
        <h3 className="relative z-10 text-lg font-semibold text-viz-heading">
          {title}
        </h3>
      </div>
